...
switch Example_Num
    case 1
        ...
        printme = @(str) print('-dpdf',sprintf('figures/sparsity_demo_complex_signal/Ex1_%s',str));
    ...
    case 2
        ...
        printme = @(str) print('-dpdf',sprintf('figures/sparsity_demo_complex_signal/Ex2_%s',str));
...
file_name = sprintf('figures/sparsity_demo_complex_signal/Ex%d_info.txt',Example_Num);
