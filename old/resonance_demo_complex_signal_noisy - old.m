%% resonance_demo_complex_noisy: Resonance decomposition (complex-valued signal)
...
switch Example_Num
    ...
    case 1
        ...
        x = x + 0.1 * (randn(1,N) + I * randn(1,N));             % add noise
        ...
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_complex_signal_noisy/Ex1_%s',str));
    ...
    case 2
        ...
        x = x + 0.02 * (randn(1,N) + I * randn(1,N));    % add noise
        ...
        % Function for printing a figure to a file
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_complex_signal_noisy/Ex2_%s',str));
...
file_name = sprintf('figures/resonance_demo_complex_signal_noisy/Ex%d_info.txt',Example_Num);
