...
For questions/comments/etc contact selesi@nyu.edu
...
itqwt.m			Inverse TQWT
			These functions are slower than tqwt_radix2 for long signals
			The radix-2 versions are preferred for practical use

test_PR.m 		Verify perfect reconstruction properties
...
version 1.9
September 15, 2026
Fixed 'gcf' run-time error in demo1 and demo1_radix2.
Revised afb.m and sfb.m (simplified code).
Some revisions in demos in saving figures as PDF files.

version 1.7
Added mex files for more versions of Matlab

version 1.6
Modify to handle complex data (mfiles)
