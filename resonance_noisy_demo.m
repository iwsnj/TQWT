...
switch Example_Num
    ...
    case 1
        ...
        FS = FigureSaver('figures/resonance_noisy_demo1/');
    ...
    case 2
        ...
        % Utility to save a figure to a PDF file
        FS = FigureSaver('figures/resonance_noisy_demo2/');
    ...
    case 3
        ...
        x = x + 0.1 * (randn(1,N) + 1j * randn(1,N));             % add noise
        ...
        FS = FigureSaver('figures/resonance_noisy_demo3/');
...
file_name = sprintf('figures/resonance_noisy_demo%d/info.txt',Example_Num);
